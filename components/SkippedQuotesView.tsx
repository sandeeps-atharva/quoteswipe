          ...
          {isLoading ? (
            <div className="flex flex-col items-center justify-center py-16">
              <div className="relative animate-bounce mb-4">
                ...
                <div className="absolute -bottom-1 -right-1 w-6 h-6 bg-gradient-to-br from-gray-500 to-slate-600 rounded-full flex items-center justify-center shadow-lg">
                  <div className="w-4 h-4 border-2 border-white border-t-transparent rounded-full animate-spin"></div>
                </div>
              </div>
              <p className="text-gray-500 font-medium">Loading skipped quotes...</p>
            </div>
          ) : quotes.length === 0 ? (
