      ...
      <div className="bg-white dark:bg-stone-900 shadow-[0_-2px_10px_rgba(0,0,0,0.05)] dark:shadow-[0_-2px_10px_rgba(0,0,0,0.3)] border-t border-stone-100 dark:border-stone-800">
        ...
        <div className="flex items-center justify-around h-14 sm:h-16 px-2 max-w-2xl mx-auto">
          ...
          >
            <Home
              ...
              className={`sm:w-6 sm:h-6 ${
                activeTab === 'feed' ? 'text-amber-500' : 'text-stone-400 dark:text-stone-500'
              }`}
          ...
          >
            <div className="relative">
              <Bookmark
                size={22}
                className={`sm:w-6 sm:h-6 ${
                  activeTab === 'saved' ? 'text-orange-500' : 'text-stone-400 dark:text-stone-500'
                }`}
          ...
          >
            ...
            >
              <div
                className={`w-12 h-12 sm:w-14 sm:h-14 -mt-4 sm:-mt-5 rounded-full flex items-center justify-center shadow-lg shadow-orange-500/30 active:scale-95 transition-all bg-gradient-to-br from-amber-500 via-orange-500 to-rose-500 ${showCreateMenu ? 'rotate-45' : ''}`}
              >
                {showCreateMenu ? (
              ...
              <span className="text-[10px] sm:text-xs font-medium text-stone-400 dark:text-stone-500 mt-0.5">
                Create
              </span>
            </button>
          </div>
          ...
          >
            <div className="relative">
              <Sparkles
                size={22}
                className={`sm:w-6 sm:h-6 ${
                  activeTab === 'myquotes' ? 'text-rose-500' : 'text-stone-400 dark:text-stone-500'
                }`}
