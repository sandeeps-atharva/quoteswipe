...
export const metadata: Metadata = {
  title: 'Contact Us',
  description:
    "Get in touch with the QuoteSwipe team. We're here to help with questions, suggestions, partnership inquiries, or feedback.",
  keywords: ['contact quoteswipe', 'customer support', 'feedback', 'help', 'support'],
  openGraph: {
    title: 'Contact QuoteSwipe - Get in Touch',
    description:
      'Reach out to the QuoteSwipe team for questions, suggestions, or partnership opportunities.',
    type: 'website',
    url: `${siteUrl}/contact`,
