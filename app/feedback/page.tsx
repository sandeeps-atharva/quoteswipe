      ...
      <div className="max-w-2xl mx-auto px-3 sm:px-4 py-6 sm:py-8">
        ...
        >
          <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
            ...
            {/* Info Box */}
            <div
              className={`p-3 sm:p-4 rounded-lg sm:rounded-xl ${theme === 'dark' ? 'bg-gray-700/50' : 'bg-blue-50'}`}
            >
              <p
                className={`text-xs sm:text-sm ${theme === 'dark' ? 'text-gray-300' : 'text-blue-700'}`}
              >
                💡 Your feedback is private and goes directly to our team. We read every message and
                use your input to improve QuoteSwipe.
              </p>
            </div>
