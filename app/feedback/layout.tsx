...
export const metadata: Metadata = {
  ...
  description:
    'Help us improve QuoteSwipe by sharing your thoughts, bug reports, feature requests, and suggestions. Your voice matters!',
  keywords: ['quoteswipe feedback', 'bug report', 'feature request', 'suggestions', 'improve'],
  openGraph: {
    title: 'Share Your Feedback - QuoteSwipe',
    description:
      'Help us improve QuoteSwipe. Share your thoughts, report bugs, or suggest new features.',
    type: 'website',
    url: `${siteUrl}/feedback`,
    images: [
      { url: '/og-image.png', width: 1200, height: 630, alt: 'Share Feedback - QuoteSwipe' },
    ],
  },
  twitter: {
