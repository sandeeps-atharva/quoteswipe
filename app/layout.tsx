...
export const metadata: Metadata = {
  ...
  description:
    "Swipe through thousands of handpicked inspirational quotes from history's greatest minds. Save your favorites, share wisdom, and find daily motivation. Free quote discovery app.",
  keywords: [
    // Primary keywords
  ...
  openGraph: {
    ...
    description:
      "Swipe through thousands of inspirational quotes from history's greatest minds. Save your favorites, share wisdom, and find daily motivation.",
    images: [
      {
        url: '/og-image.png',
        width: 1200,
  ...
  twitter: {
    ...
    title: 'QuoteSwipe - Discover Inspirational Quotes Daily',
    description:
      'Swipe through thousands of inspirational quotes. Save your favorites and share wisdom.',
    images: ['/og-image.png'],
    creator: '@quoteswipe',
  },
  robots: {
...
const jsonLd = {
  ...
  name: 'QuoteSwipe',
  description:
    "Swipe through thousands of inspirational quotes from history's greatest minds. Save your favorites and share wisdom.",
  url: siteUrl,
    ...
    <html lang="en" suppressHydrationWarning>
      <head>
        ...
        <meta
          ...
          content="fLzbYgaZzmMOAE4_dHCPhIaw-febGh3FBSHxhMeljCY"
        />
