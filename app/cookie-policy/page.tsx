  ...
  const cookieTypes = [
    {
      ...
      required: true,
      description:
        'These cookies are necessary for the website to function properly. They enable core features like security, authentication, and session management.',
    ...
    },
    {
      ...
      required: false,
      description:
        'These cookies remember your preferences and settings to provide a personalized experience, such as your language choice and theme settings.',
    ...
    },
    {
      ...
      required: false,
      description:
        'These cookies help us understand how visitors interact with our website by collecting anonymous information about page visits and usage patterns.',
    ...
    },
    {
      ...
      required: false,
      description:
        'These cookies enable enhanced functionality and personalization, such as remembering your saved quotes and liked content.',
    ...
    >
      ...
      >
        <p className="text-xs sm:text-sm md:text-base text-gray-600 dark:text-gray-400 leading-relaxed">
          ...
          to provide information to website owners. Cookies help us remember your preferences,
        ...
        {cookieTypes.map((cookie, index) => (
          <SectionCard key={index}>
            <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-2 sm:gap-4 mb-3 sm:mb-4">
              ...
              <span
                className={`self-start sm:self-auto px-2 sm:px-3 py-0.5 sm:py-1 rounded-full text-[10px] sm:text-xs font-medium whitespace-nowrap ${
                  cookie.required
      ...
      <SectionCard className="mb-6 sm:mb-8">
        ...
        <ul className="space-y-2 sm:space-y-3 ml-2 sm:ml-3 md:ml-4">
          <ListItem>
            Browser Settings: Most browsers allow you to refuse or accept cookies through their
            settings menu.
          </ListItem>
          <ListItem>
            Third-Party Tools: Various browser extensions can help you manage cookies and tracking.
          </ListItem>
          <ListItem>
            Opt-Out Links: Some analytics services provide opt-out mechanisms on their websites.
          </ListItem>
          <ListItem>
            Device Settings: Mobile devices often have settings to limit ad tracking and cookies.
          </ListItem>
        </ul>
        <div className="mt-4 sm:mt-5 md:mt-6 p-3 sm:p-4 bg-gradient-to-r from-amber-500/5 to-rose-500/5 dark:from-amber-500/10 dark:to-rose-500/10 rounded-lg sm:rounded-xl border border-blue-200/50 dark:border-pink-800/50">
          <p className="text-[10px] sm:text-xs md:text-sm text-gray-700 dark:text-gray-300">
            ...
            website. You may not be able to use certain features like saving quotes or maintaining
            your login session.
          </p>
        </div>
      </SectionCard>
      ...
      <SectionCard>
        ...
        <p className="text-xs sm:text-sm md:text-base text-gray-600 dark:text-gray-400">
          ...
          policy periodically for any changes. The date at the top of this policy indicates when it
          was last updated.
        </p>
      </SectionCard>
